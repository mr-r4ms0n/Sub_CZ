...
public class RandomG implements Runnable
{
    ...
    CalculaSubC subC;
    public static ArrayList<Resultado> lista = new ArrayList<Resultado>();
    ...
    public void run()
    {
        ...
        while (!stopped)
        {
            try
            {
                ...
                //Le echamos la calculada
                subC = new CalculaSubC(arr, ChConj.suma, lista);
            ...
            {
                System.err.println("Hilo de Numeros Random interrumpido" + ex);
            }
        }
    }
}
